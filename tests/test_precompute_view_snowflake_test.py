...
class MostViewedTestCase(RecsTestCase):
    ...
    def test_view_by_no_geo_30_days(self):
        ...
        self._run_recs_test(algorithm="view", lookback=30, filter_json=filter_json, expected_result=[
            '"{filter_hash}","SKU-00002",1'.format(filter_hash=filter_hash),
            '"{filter_hash}","SKU-00003",2'.format(filter_hash=filter_hash),
            '"{filter_hash}","SKU-00005",3'.format(filter_hash=filter_hash),
            '"{filter_hash}","SKU-00006",4'.format(filter_hash=filter_hash),
