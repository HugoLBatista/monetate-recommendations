...
class PurchaseAlsoPurchaseTestCase(RecsTestCaseWithData):
    ...
    def test_default_attrbute_weights_enabled_similar_products_v2(self):
        ...
        recs_models.AccountRecommendationSetting.objects.get_or_create(
            account=self.account,
            similar_product_weights=json.dumps({{"enabled_catalog_attributes":
                                                     [{"catalog_attribute": "color", "weight": 0.5},
                                                      {"catalog_attribute": "product_type", "weight": 0.1},
                                                      ]}})
        )
        recs1_expected_result = [
            ('TP-00001', [('SKU-00002', 1), ('SKU-00003', 2)]),
            ('TP-00002', [('SKU-00001', 1), ('SKU-00003', 2)]),
            ('TP-00003', [('SKU-00001', 1), ('SKU-00002', 2), ('SKU-00004', 3)]),
            ('TP-00004', [('SKU-00003', 1), ('SKU-00005', 2)]),
